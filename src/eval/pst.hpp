...
[[nodiscard]] constexpr Score pst_value(const chess::Piece piece, const chess::Square sq) {
    if constexpr (side == chess::Side::White) {
        return pst[static_cast<int>(piece)][static_cast<int>(sq)];
    } else {
        return pst[static_cast<int>(piece)][static_cast<int>(sq.flip())];
    }
}

static_assert(pst_value<chess::Side::White>(chess::Piece::Pawn, chess::squares::A2) == Score{-1, -17});
static_assert(pst_value<chess::Side::Black>(chess::Piece::Pawn, chess::squares::A7) == Score{-1, -17});
static_assert(pst_value<chess::Side::White>(chess::Piece::Pawn, chess::squares::A7) == Score{118, 82});
static_assert(pst_value<chess::Side::Black>(chess::Piece::Pawn, chess::squares::A2) == Score{118, 82});
static_assert(pst_value<chess::Side::White>(chess::Piece::Knight, chess::squares::D4) == Score{3, 16});
static_assert(pst_value<chess::Side::Black>(chess::Piece::Knight, chess::squares::D5) == Score{3, 16});
static_assert(pst_value<chess::Side::White>(chess::Piece::Knight, chess::squares::D5) == Score{33, 31});
static_assert(pst_value<chess::Side::Black>(chess::Piece::Knight, chess::squares::D4) == Score{33, 31});
