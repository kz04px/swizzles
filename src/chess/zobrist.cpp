...
const hash_type key_turn = 0x679ebe6f2ed869a4ULL;

const std::array<hash_type, 16> key_castling = {
    0x6b63254b15e00a87ULL,
    0x098dc1575ddbd151ULL,
    0xdbb675f686df04a9ULL,
    0x71588a053b2bd9e5ULL,
    0x75a9afa962ee165dULL,
    0x01bbec6d713bc5ecULL,
    0xbea606eeb75fe033ULL,
    0x1de87553764fb0d3ULL,
    0x8a55e7dd370edbabULL,
    0xcd64c36f4e1e1848ULL,
    0x3467d5f229fa519eULL,
    0x74376394207ad09dULL,
    0x471664012ec5de2eULL,
    0xb95f37d5445e569dULL,
    0x00486c6858826973ULL,
    0x9005af5863f7aea0ULL,
};

const std::array<hash_type, 8> key_ep = {
...
const std::array<hash_type, 6 * 2 * 64> key_piece = {
...
[[nodiscard]] auto piece_key(const PieceType p, const Colour c, const Square sq) noexcept -> hash_type {
    return key_piece[64 * 2 * index(p) + 64 * index(c) + index(sq)];
}

[[nodiscard]] auto ep_key(const Square sq) noexcept -> hash_type {
    return key_ep[file(sq)];
}
