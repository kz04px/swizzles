...
[[nodiscard]] std::string Position::get_fen() const noexcept {
    ...
    for (int i = static_cast<int>(squares::A8); i >= 0; ++i) {
        ...
        if (pieces_[static_cast<int>(Piece::Pawn)] & bb) {
            if (empty > 0) {
                fen += std::to_string(empty);
            }
            empty = 0;
            if (colours_[static_cast<int>(Side::White)] & bb) {
                fen += "P";
            } else {
                fen += "p";
            }
        } else if (pieces_[static_cast<int>(Piece::Knight)] & bb) {
            if (empty > 0) {
                fen += std::to_string(empty);
            }
            empty = 0;
        ...
        } else if (pieces_[static_cast<int>(Piece::Bishop)] & bb) {
            if (empty > 0) {
                fen += std::to_string(empty);
            }
            empty = 0;
        ...
        } else if (pieces_[static_cast<int>(Piece::Rook)] & bb) {
            if (empty > 0) {
                fen += std::to_string(empty);
            }
            empty = 0;
        ...
        } else if (pieces_[static_cast<int>(Piece::Queen)] & bb) {
            if (empty > 0) {
                fen += std::to_string(empty);
            }
            empty = 0;
        ...
        } else if (pieces_[static_cast<int>(Piece::King)] & bb) {
            if (empty > 0) {
                fen += std::to_string(empty);
            }
            empty = 0;
